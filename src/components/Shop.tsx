                                ...
                                <div className="row g-4">
                                    ...
                                    <div className="col-lg-12">
                                        <div className="mb-3">
                                            ...
                                            <input type="range" className="form-range w-100" id="rangeInput" name="rangeInput" min="0" max="500" defaultValue="0" onInput={(e) => { (document.getElementById('amount') as HTMLInputElement).value = (e.target as HTMLInputElement).value; }} />
                                    ...
                                    <div className="col-lg-12">
                                        ...
                                        {/* Featured products can be mapped from an array */}
                                        {/* Example product */}
